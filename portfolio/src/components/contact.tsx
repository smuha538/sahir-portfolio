      ...
      <RevealUp>
        <div className="px-4 w-full min-w-[300px] md:w-[500px] sm:w-2/3 p-6 bg-[url(/images/form.svg)] rounded-lg">
          ...
          <form className="space-y-6 outfit-text" onSubmit={onSubmit}>
            ...
            <button
              type="submit"
              className="w-full text-white py-3 px-6 rounded-lg transition relative overflow-hidden hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(60,135,250,0.4)] border-white"
            >
              Send Message
            </button>
          </form>
